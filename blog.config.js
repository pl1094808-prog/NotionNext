...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Partricia Huihui', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO ||  '慧慧是一种神秘外星生物' , // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.patriciahuihui.online/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '慧慧的，博客', // 网站关键词 英文逗号隔开
